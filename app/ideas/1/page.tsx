    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="flex items-center gap-2 mb-4 text-sm text-muted-foreground">
          ...
          <span className="font-medium">Idea #1</span>
        </div>
        ...
        <div className="mb-8">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl">European Freelancers & Small Agencies Struggle</CardTitle>
            </CardHeader>
        ...
        <div className="mb-8">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl">A Micro-SaaS for EU Testimonials</CardTitle>
        ...
        <div className="mb-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>€19-99/mo tiered pricing targeting different segments of the EU freelancer/agency market</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
